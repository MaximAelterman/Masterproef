...
if __name__ == "__main__":
    ...
    net = load_net("cfg/yolov3_gpu.cfg", "yolov3.weights", 0)
    ...
    result_file = open("prediction.txt", "w")
    ...
    for detection in r:
        ...
        if label == "car":
            ...
            prediction_data.append("0 ")                                            #truncated: object leaves the picture
            prediction_data.append("3 ")                                            #occluded: unknown
            prediction_data.append("0 ")                                            #alpha: viewing angle (-pi ... pi)
            prediction_data.append(str(x1)+" "+str(y1)+" "+str(x2)+" "+str(y2)+" ") #bounding box
            prediction_data.append(str(height)+" "+str(width)+" "+str(length)+" ")  #dimensions: height, width, length
            prediction_data.append("0 0 0 ")                                        #location
            prediction_data.append("0 0 0 ")                                        #location_y
