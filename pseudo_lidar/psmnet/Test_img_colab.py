...
def main():
       ...
       img = cv2.normalize(src=img, dst=img, beta=0, alpha=255, norm_type=cv2.NORM_MINMAX)  
       img = np.uint8(img)

       skimage.io.imsave('/content/gdrive/My Drive/Masterproef/pseudo_lidar/psmnet/disparity.png',img)
       np.save('/content/gdrive/My Drive/Masterproef/pseudo_lidar/psmnet/disparity.npy', pred_disp)
